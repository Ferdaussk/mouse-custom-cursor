...
function mcustomc_admin_notice_missing_main_plugin() {
	...
	if (mcustomc_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Mouse Custom Cursor</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Mouse Custom Cursor</b> requires Elementor to be installed and activated.</p>';
...
function mcustomc_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Mouse Custom Cursor</b> does not work since you are using an older version of Elementor</p>';
...
function mcustomc_addon_install() {
    $file_path = 'elementor/elementor.php';
